...
<div class="struct-card">
    ...
    <p class="lang-ru">Высокая наблюдательная вышка. Отличное место для старта, содержит базовые механизмы Create.</p>
    <p class="lang-en">Tall observation tower. Great early game structure containing basic Create components.</p>

    <details class="loot-details">
        <summary class="btn" style="width:100%; text-align:left;">Show Loot (Лут)</summary>
        <table class="loot-table">
            <tr><th>Item</th><th>Chance (per roll)</th><th>Pool Rolls</th></tr>
            ...
            <tr><td colspan="3" style="font-size:0.8em; color:var(--text-muted);">Also: XP Bottles (28%), Enchanted Books (15%), Ender Pearls (9%).</td></tr>
        </table>
    </details>
</div>
...
<div class="struct-card">
    ...
    <details class="loot-details">
        ...
        <table class="loot-table">
            ...
            <tr><td>Explorer Map (Buried Treasure)</td><td class="chance-low">4.5%</td></tr>
        </table>
    </details>
</div>
...
<div class="struct-card">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <span class="biome-tag">Birch Forest</span> <span class="biome-tag">Taiga</span> <span class="biome-tag">Savanna</span>
    </div>

    <div class="screenshot-placeholder">
        <div class="lang-ru">Скриншот отсутствует. <br><code>denmoth8871top@gmail.com</code></div>
        <div class="lang-en">Screenshot missing.</div>
    </div>

    <p class="lang-ru">Небольшое почтовое отделение или пункт связи.</p>
    <p class="lang-en">Small post office or communication outpost.</p>
</div>
...
<div class="struct-card">
    ...
    <p class="lang-ru">Генерируют кинетическую энергию. Материал постройки зависит от биома (Дуб, Ель, Береза, Акация, Вишня).</p>
...
<div class="struct-card">
    ...
    <div style="margin-bottom: 15px;">
        ...
        <span class="biome-tag">Savanna</span> <span class="biome-tag">Cherry Grove</span>
    </div>

    <p class="lang-ru">Стеклянная структура для выращивания растений.</p>
    <p class="lang-en">Glass structure for farming.</p>
</div>
...
<div class="struct-card">
    ...
    <p class="lang-ru">Заброшенный дом с паутиной и редким лутом. Есть 3 вариации.</p>
    ...
    <details class="loot-details">
        ...
        <table class="loot-table">
            ...
            <tr><td>Create: Smart Chute</td><td class="chance-low">8%</td></tr>
            <tr><td>Music Disc 13</td><td class="chance-low">4.8%</td><td style="font-size:0.8em;">(Pool 2)</td></tr>
        </table>
    </details>
</div>
...
<div class="struct-card">
    ...
    <p class="lang-ru">Разрушенный портал в стиле Crimson Forest (Багрового леса).</p>
</div>
